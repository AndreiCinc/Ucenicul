...
FAMILIES: List[Tuple[str, Callable[[], List[TestCase]], Callable[[List[TestCase]], None]]] = [
    ...
    # Harness-infra disabled per PHASE_3_REPAIR_BACKLOG.md R1 — legacy
    # docs/ucenicul_claude_handoff_hardened artifacts were removed. Contract
    # coverage is preserved by the other nine runtime-behaviour families.
]
