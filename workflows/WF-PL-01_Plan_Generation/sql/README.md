...
Workflow-specific off-node SQL for WF-PL-01 Plan Generation.
...
- These files are the canonical location for WF-PL-01 off-node SQL.

## Not source of truth

- Node-level SQL inside `../workflow/WF-PL-01_Plan_Generation.json` is canonical inside the JSON, not here.
