// Pure candidate for ME_Memory_Store_Prep post-patch.
// Derived from the n8n Code node jsCode by lifting the $() lookups into
// (env, step) parameters. Body byte-equivalent after that lift.
...
export default function storePrep(env, step) {
  ...
  // Subjective guards only apply to observation/pattern — skipping for 'fact' tests
